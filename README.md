...
This project aims to do the same for an undergraduate Computer Science degree (https://github.com/datasciencemasters/go). The following document lists free online courses from prestigious universities such as Harvard, Stanford, and MIT. The Term groupings are intended to pace and structure the course in the manner of a typical Computer Science track at a college or university. The emphasis is on core Computer Science courses; liberal arts or "GenEd" courses are not included.
